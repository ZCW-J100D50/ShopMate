...
import static com.shopmate.app.domain.UserProfileAsserts.*;
...
import com.shopmate.app.domain.UserProfile;
import com.shopmate.app.repository.UserProfileRepository;
...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().nickName(DEFAULT_NICK_NAME);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().nickName(UPDATED_NICK_NAME);
        return userProfile;
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.nickName(UPDATED_NICK_NAME);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.nickName(UPDATED_NICK_NAME);
