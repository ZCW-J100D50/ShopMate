  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="shopmateApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Nick Name" id="user-profile-nickName" name="nickName" data-cy="nickName" type="text" />
