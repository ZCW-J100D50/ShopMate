            ...
            <tbody>
              {tripList.map((trip, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{trip.name}</td>
                  <td>{trip.budget}</td>
                  <td>{trip.date ? <TextFormat type="date" value={trip.date} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{trip.vendor ? <Link to={`/vendor/${trip.vendor.id}`}>{trip.vendor.id}</Link> : ''}</td>
                  <td>{trip.userProfile ? <Link to={`/user-profile/${trip.userProfile.id}`}>{trip.userProfile.id}</Link> : ''}</td>
