...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vendor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENDOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VENDOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VENDOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VENDOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VENDOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VENDOR actions', async () => {
      const arg = 42666;
